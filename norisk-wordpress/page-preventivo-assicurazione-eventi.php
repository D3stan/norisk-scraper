...
const CONFIG = {
    ...
    CANCELLATION_MODAL_INCLUDE: <?php echo json_encode( wp_kses_post( $norisk['cancellation_modal_include'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    CANCELLATION_MODAL_EXCLUDE: <?php echo json_encode( wp_kses_post( $norisk['cancellation_modal_exclude'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    LIABILITY_MODAL_TITLE: '<?php echo esc_js( $norisk['liability_modal_title'] ); ?>',
    LIABILITY_MODAL_INCLUDE: <?php echo json_encode( wp_kses_post( $norisk['liability_modal_include'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    LIABILITY_MODAL_EXCLUDE: <?php echo json_encode( wp_kses_post( $norisk['liability_modal_exclude'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    EQUIPMENT_MODAL_TITLE: '<?php echo esc_js( $norisk['equipment_modal_title'] ); ?>',
    EQUIPMENT_MODAL_INCLUDE: <?php echo json_encode( wp_kses_post( $norisk['equipment_modal_include'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    EQUIPMENT_MODAL_EXCLUDE: <?php echo json_encode( wp_kses_post( $norisk['equipment_modal_exclude'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    MONEY_MODAL_TITLE: '<?php echo esc_js( $norisk['money_modal_title'] ); ?>',
    MONEY_MODAL_INCLUDE: <?php echo json_encode( wp_kses_post( $norisk['money_modal_include'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
    MONEY_MODAL_EXCLUDE: <?php echo json_encode( wp_kses_post( $norisk['money_modal_exclude'] ), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG ); ?>,
